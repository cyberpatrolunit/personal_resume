            ...
            <div className="404">
              <pre>
                <code>
                  ...
                  <br />
                  <span className="orange indent1">&lt;html&gt;</span>
                  <br />
                  <span className="orange indent2">&lt;style&gt;</span>
                  <br />
                  <span className="green indent3">* {'{'}</span>
                  <br />
                  <span className="green indent4">everything</span>: <span className="blue">awesome</span>;
                  <br />
                  <span className="green indent3">{'}'}</span>
                  <br />
                  <span className="orange indent2">&lt;/style&gt;</span>
                  <br />
                  <span className="orange indent2">&lt;body&gt;</span>
                  <br />
                  <span className="error-text">ERROR 404!</span>
                  <br />
                  <span className="error-text">FILE NOT FOUND!</span>
                  <br />
                  <span className="comment indent3">
...
.indent1 {
  ...
  .error-text {
    font-size: 48px; /* Adjust font-size to your preference for "ERROR 404" and "FILE NOT FOUND" */
    font-weight: bold; /* Optional: if you want the error text to be bold */
    font-family: OCR-A;
